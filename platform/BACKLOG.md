...
A primeira história a ser implementada é **US-001 — Base de qualidade e dados sintéticos**, seguida de **US-002 — Conta individual e sessão segura**. A primeira não exige fonte externa e reduz o risco de todas as histórias seguintes; a segunda habilita a proteção efetiva do restante do MVP.
