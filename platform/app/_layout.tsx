...
import { configureMedicationReminderPresentation } from "@/lib/medication-reminders";
...
export default function RootLayout() {
  ...
  useEffect(() => {
    initManusRuntime();
    configureMedicationReminderPresentation();
  }, []);
        ...
        <QueryClientProvider client={queryClient}>
          ...
          {/* in order for ios apps tab switching to work properly, use presentation: "fullScreenModal" for login page, whenever you decide to use presentation: "modal*/}
            <Stack screenOptions={{ headerShown: false }}>
              ...
              <Stack.Screen name="care-contacts" />
              <Stack.Screen name="caregiver-routine" />
              ...
              <Stack.Screen name="service-directory" />
              <Stack.Screen name="prototype-services" />
              <Stack.Screen name="prototype-portals" />
              <Stack.Screen name="institutional-demo" />
              <Stack.Screen name="prototype-care-explorer" />
