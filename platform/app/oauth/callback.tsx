    ...
    const handleCallback = async () => {
      try {
        ...
        if (params.sessionToken) {
          ...
          // Recupera a identidade pela API após armazenar a sessão. Isso evita
          // depender de Buffer/atob, que podem não estar disponíveis no runtime nativo.
          ...
          if (apiUser) {
            try {
              ...
              console.error("[OAuth] Failed to persist authenticated user:", err);
            }
          }
